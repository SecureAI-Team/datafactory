...
export function InteractiveCard({
  ...
  return (
    <div className="bg-gradient-to-br from-dark-800/90 to-dark-900/90 border border-dark-700/50 rounded-xl p-5 shadow-lg backdrop-blur-sm max-w-lg animate-fade-in">
      {/* Header */}
